    ...
    <div className='bg-slate-800 pt-14'>
        <div className='lg:h-[700px] max-w-7xl mx-auto flex md:flex-row flex-col gap-10 items-center'>
            <div className='space-y-7 px-4 md:px-0'>
              ...
              <p className='text-gray-300 text-lg'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Unde distinctio, odio nihil non eveniet repellendus magnam vero in placeat iure illum, inventore blanditiis rerum quas cumque et laborum vitae labore.</p>
              <div className='inline-flex relative'>
                <input type="text" placeholder='Search Your course Here...' className='bg-gray-200 w-[350px] md:w-[450px]
